...
<div class="container-fluid">
    <form action="" id="prison-type-form">
        ...
        <div class="form-group">
            <label for="prison_id" class="control-label">Exempt list</label>
...
<script>
    $(document).ready(function(){
        ...
        $('#prison-type-form').submit(function(e){
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"admin/model/save_exempt_list.php",
                ...
                success:function(resp){
                    ...
                    if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        uni_modal("<i class='fa fa-th-list'></i> Cell Block Details ","exempt_list/view_exempt_list.php?id="+resp.id)
