...
<div class="content py-3 bg-gradient-navy px-3">
    <div class="d-flex justify-content-between align-items-center">
        <h2>Hire inmates to <?= $row['name'] ?></h2>
    </div>
</div>
<div class="row mt-n4 justify-content-center align-items-center">
    <div class="col-md-4">
        <div class="card">
            <form method ="post" action="model/inmate_job.php">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-striped table-hover datatables-basic" id="list">
                    ...
                    $i = 1;
                    $sql = "
                    select concat(i.lastname,', ', i.firstname, coalesce(concat(' ', i.middlename), '')) as `name`,t.date_created, t.id, t.job_id from inmate_job t inner join inmate_list i on i.id = t.inmate_id where t.job_id = '$id' order by t.date_created desc
                    ";
                    ...
                    foreach($inmates as $row){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="model/delete_job_placement.php?id=<?= $row['id'] ?>&job_id=<?= $id ?>"  class="btn btn-sm btn-danger">
