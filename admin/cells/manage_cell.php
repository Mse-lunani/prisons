...
<div class="container-fluid">
	<form action="" id="cell-form">
		...
		<div class="form-group">
			...
			<select name="prison_id" id="prison_id" class="form-control  rounded-0" required="required">
		...
		<div class="form-group">
			...
			<select name="status" id="status" class="form-control  rounded-0" required="required">
