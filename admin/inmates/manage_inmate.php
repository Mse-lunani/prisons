...
<div class="content py-4 bg-gradient-navy px-3">
    <h4 class="m-3"><?= isset($id) ? "Update Inmate" : "New Inmate Entry" ?></h4>
</div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  rounded-0" name="firstname" id="firstname" required="required" value="<?= isset($firstname) ? $firstname : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="middlename" class="control-label">Middle Name</label>
                                    <input type="text" class="form-control  rounded-0" name="middlename" id="middlename" placeholder="optional" value="<?= isset($middlename) ? $middlename : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="lastname" class="control-label">Last Name</label>
                                    <input type="text" class="form-control  rounded-0" name="lastname" id="lastname" required="required" value="<?= isset($lastname) ? $lastname : "" ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control  rounded-0" name="dob" id="dob" required="required" value="<?= isset($dob) ? $dob : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="sex" class="control-label">Sex</label>
                                    <select class="form-control  rounded-0" name="sex" id="sex" required="required">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" class="form-control  rounded-0" name="address" id="address" required="required"><?= isset($address) ? $address : "" ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control  rounded-0" name="marital_status" id="marital_status" required="required">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="complexion" class="form-control  rounded-0" name="complexion" id="complexion" required="required" value="<?= isset($complexion) ? $complexion : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="eye_color" class="control-label">Eye Color</label>
                                    <input type="text" class="form-control  rounded-0" name="eye_color" id="eye_color" required value="<?= isset($eye_color) ? $eye_color : "" ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  rounded-0" name="crime_ids[]" id="crime_ids" required="required" multiple>
                                            <?php 
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="sentence" class="form-control  rounded-0" name="sentence" id="sentence" required="required" value="<?= isset($sentence) ? $sentence : "" ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control  rounded-0" name="date_from" id="date_from" required="required" value="<?= isset($date_from) ? date("Y-m-d", strtotime($date_from)) : "" ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="date_to" class="control-label">Time Serve Ends</label>
                                        <input type="date" class="form-control  rounded-0" name="date_to" id="date_to" value="<?= isset($date_to) ? date("Y-m-d", strtotime($date_to)) : "" ?>">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="emergency_name" class="form-control  rounded-0" name="emergency_name" id="emergency_name" value="<?= isset($emergency_name) ? $emergency_name : "" ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  rounded-0" name="emergency_relation" id="emergency_relation" value="<?= isset($emergency_relation) ? $emergency_relation : "" ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="emergency_contact" class="control-label">Contact #</label>
                                        <input type="text" class="form-control  rounded-0" name="emergency_contact" id="emergency_contact" value="<?= isset($emergency_contact) ? $emergency_contact : "" ?>">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
