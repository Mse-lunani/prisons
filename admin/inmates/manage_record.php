...
<div class="container-fluid">
    <form action="" id="record-form">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control  rounded-0" name="date" id="date" required="required" value="<?= isset($date) ? date("Y-m-d", strtotime($date)) : date('Y-m-d') ?>">
        </div>
        <div class="form-group">
            <label for="action_id" class="control-label">Action</label>
            <select class="form-control  rounded-0" name="action_id" id="action_id" required="required">
        ...
        <div class="form-group">
            ...
            <textarea id="remarks" name="remarks" rows="5" class="form-control  rounded-0" required><?= isset($remarks) ? $remarks : '' ?></textarea>
        </div>
    </form>
</div>
<script>
