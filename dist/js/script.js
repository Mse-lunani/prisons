                ...
                success: function(resp) {
                    ...
                    if (resp) {
                        ...
                        if (resp.status == 'success') {
                            ...
                            var _frm = $('#login-frm')
                            var _msg = "<div class='alert bg-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Incorrect username or password</div>"
                            _frm.prepend(_msg)
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    ...
                    $('#msg').html('<div class="alert bg-danger err_msg">' + resp.msg + '</div>')
                    $("html, body").animate({ scrollTop: 0 }, "fast");
                } else {
                    $('#msg').html('<div class="alert bg-danger err_msg">An Error occured</div>')
                }
                end_loader()
            }
        })
